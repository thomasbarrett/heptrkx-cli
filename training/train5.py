...
def main():
    ...
    learning_rate           = 0.001
    restore_path            = './results/train5/models/model39.ckpt'
    restore_index           = 40
    ...
    node_param_diff = node_param_out - node_param_in
    ...
    node_param_diff_truth = node_param_out_truth - node_param_in_truth
    
    node_param_loss_op = tf.losses.absolute_difference(node_param_diff_truth, node_param_diff)
